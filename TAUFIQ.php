...
#JANAGAN DI SALAH GUNAKAN YA MBAAH KARNA  INI BUAT ORANG YANG SUKA(MENIPU SMS)
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		...
		echo "[]TAUFIQ Sending Massage To[] # ".$G.$argv[1].$X."\n";	
...
echo "[]TAUFIQ Sending Massage To[] # ".$G.$argv[2].$X."\n";
